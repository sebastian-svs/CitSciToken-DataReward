    ...
    ERC1820Implementer
{
    ...
    uint256 public streamingDuration = 1800; //here the streaming duration can be defined in seconds 1800
    uint256 public streamingInterval = 180; //here the streaming payout Intervall can be defined in seconds 180
